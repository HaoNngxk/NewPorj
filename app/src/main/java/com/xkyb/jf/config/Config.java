package com.xkyb.jf.config;

import com.xkyb.jf.R;
import com.xkyb.jf.ui.fragment.CategorizeFragment;
import com.xkyb.jf.ui.fragment.IndexFragment;
import com.xkyb.jf.ui.fragment.UserFragment;
...
public final class Config {
 ...
 //   public static final int[] pics = {R.mipmap.guide1, R.mipmap.guide2, R.mipmap.guide3, R.mipmap.guide4};
    ...
    public static final int[] tabImgs = {
            R.drawable.home, R.drawable.categorize, R.drawable.user
    };
    ...
    public static final Class[] tabClass = {
             CategorizeFragment.class,IndexFragment.class, UserFragment.class
    };
...
/*    public static final int[] categorizeToolsImg = {
    ...
    public static final int[] recommdendListImg = {
            R.mipmap.tea, R.mipmap.beauty, R.mipmap.food, R.mipmap.hotel, R.mipmap.ktv, R.mipmap.life,R.mipmap.relax, R.mipmap.shop
    };
    ...
    public static final String[] recommdendListTexts = {
            "茶社", "美食餐饮", "酒店住宿", "KTV", "商场购物", "休闲娱乐","生活服务","丽人"
    };
