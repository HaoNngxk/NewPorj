...
import com.xkyb.jf.api.ServiceApi;
...
/*        phone = register_phone.getEditText().getText().toString().trim();
    ...
    private void doRegister() {
        if (checkUpResult) {
            ...
            newUser.setToken("11111111111");
            newUser.setPhone("15101507938");
            newUser.setTime("11111111111");
            mDialog.show();
            OkHttpClient.Builder builder = new OkHttpClient.Builder();
            Call<String> loginCall=RetrofitHttp.getRetrofit(builder.build()).registerUser("11111111111", "11111111111","15101507938");
